...
namespace Citms.EntityFrameworkCore.OracleProperties
{
    /// <summary>
    ...
    public static class OracleStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Citms.EntityFrameworkCore.OracleProperties.OracleStrings", typeof(OracleStrings).GetTypeInfo().Assembly);
