...
namespace EFCore.Oracle.Storage.Internal
{
    ...
    {
        private readonly IOracleRelationalConnection _connection;
	    ...
	    public OracleDatabaseCreator(
            ...
            [NotNull] IOracleRelationalConnection connection,
        ...
        private IReadOnlyList<MigrationCommand> CreateCreateOperations()
        {
            ...
            return Dependencies.MigrationsSqlGenerator.Generate((new[] { new OracleCreateDatabaseOperation { Name = _connection.DbConnection.Database } }));
        }
        ...
        private static bool IsDoesNotExist(OracleException exception) => exception.Number == 1049;
        ...
        private void ClearPool() => OracleConnection.ClearPool(_connection.DbConnection as OracleConnection);
    }
}
