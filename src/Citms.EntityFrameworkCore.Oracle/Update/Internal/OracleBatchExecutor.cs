...
namespace EFCore.Oracle.Update.Internal
{
    ...
    public class OracleBatchExecutor : IBatchExecutor
    {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            OracleRelationalTransaction startedTransaction = null;
            try
            {
                if (connection.CurrentTransaction == null)
                {
                    // ReSharper disable once PossibleNullReferenceException
                    startedTransaction = await (connection as OracleRelationalConnection).BeginTransactionAsync(cancellationToken).ConfigureAwait(false) as OracleRelationalTransaction;
                }
